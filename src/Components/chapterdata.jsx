      ...
      Physics: [
        ...
        },
        {
          ...
          questions : [
            ...
            "2. Explain the difference between the valence electrons and the co-valency of an element. (AS1)",
            "3. A chemical compound has the following Lewis notation: (AS1)(a) How many valence electrons does element Y have? b) What is the valency of element Y c) What is the valency of element X? d) How many covalent bonds are there in the molecule  e) To which groups the elements X and Y belong? (AS2)",
            "4. Why do only valence electrons involve in bond formation? Why not electrons of inner shells? Explain. (AS1)",
            "5. How do bond energies and bond lengths of molecules help us in predicting their chemical properties? Explain with examples. (AS1)",
            "6. Draw simple diagrams to show how electrons are arranged in the following covalent molecules: (AS5) a) Calcium oxide (CaO)  b) Water (H2O) c) Chlorine (Cl2)",
            "7. Represent the molecule H2O using Lewis notation. (AS5)",
            "8. Represent each of the following atoms using Lewis notation:  a) Beryllium b) Calcium c) Lithium d) Bromine gas (Br2) e) Calcium chloride (CaCl2)  f) Carbon dioxide (CO2)",


            "9. What is the octet rule? How do you appreciate the role of the ‘octet rule’ in explaining the chemical properties of elements? (AS6)",
            "10. What is hybridization? Explain the formation of the following molecules using hybridization: a) BeCl2 b) BF",
           
            "1. Explain the formation of sodium chloride and calcium oxide on the basis of the concept of electron transfer from one atom to another atom. (AS1)",
            "2. A, B, and C are three elements with atomic numbers 6, 11, and 17 respectively   i. Which of these cannot form an ionic bond? Why? (AS1)   ii. Which of these cannot form a covalent bond? Why?    iii. Which of these can form both ionic and covalent bonds? (AS1)",
            "3. Predict the reasons for the low melting point of covalent compounds compared to ionic compounds. (AS2)",
            "4. How does the Lewis dot structure help in understanding bond formation between atoms? (AS6)",
            "5. Explain the formation of the following molecules using valence bond theory:   a) N2 molecule   b) O2 molecule",
          
            "1. Two chemical reactions are described below.    • Nitrogen and hydrogen react to form ammonia (NH3)  • Carbon and hydrogen bond together to form a molecule of methane (CH4)   For each reaction, give:   a) The valence of each of the atoms involved in the reaction. (AS1)   b) The Lewis structure of the product that is formed."
          ]
          
        },
        {
          chapter: "Chapter 9: Electric Current",
          subchapters: [],
          questions : [
            ...
            "6. Explain Kirchhoff’s laws with examples. (AS1)",
            "7. What is a value of 1 KWH in Joules? (AS1)",
            "8. Deduce the expression for the equivalent resistance of three resistors connected in series. (AS1)",
            "9. Deduce the expression for the equivalent resistance of three resistors connected in parallel. (AS1)",
            "10. Silver is a better conductor of electricity than copper. Why do we use copper wire for conduction of electricity? (AS1)",
            "11. Draw a circuit diagram for a circuit in which two resistors A and B are connected in series with a battery, and a voltmeter is connected to measure the potential difference across resistor A. (AS5)",
            "12. In the figure Q-12, the potential at A is ————— when the potential at B is zero. (AS7)",
          
            "1. Explain overloading of household circuit. (AS1)",
            "2. Why do we use fuses in household circuits? (AS1)",
            "3. Two bulbs have ratings 100 W, 220V and 60 W, 220V. Which one has the greater resistance? (AS1)",
            "4. Why don’t we use series arrangement of electrical appliances like bulbs, television, fan, and others in domestic circuits? (AS1)",
            "5. A wire of length 1m and radius 0.1 mm has a resistance of 100 Ω. Find the resistivity of the material. (AS1)",
            "6. Why do we consider tungsten as a suitable material for making the filament of a bulb? (AS2)",
            "7. Are the headlights of a car connected in series or parallel? Why? (AS2)",
            "8. Why should we connect electric appliances in parallel in a household circuit? What happens if they are connected in series? (AS2)",
            "9. How can you appreciate the role of a small fuse in a house wiring circuit in preventing damage to various electrical appliances connected in the circuit? (AS7)",
            "10. If the resistance of your body is 100000Ω, what would be the current that flows in your body when you touch the terminals of a 12V battery? (AS7)",
            "11. Uniform wires of resistance 100Ω are melted and recast into a wire of length double that of the original. What would be the resistance of the new wire formed? (AS7)",
            ...
            "2. Observe the circuit and answer the questions given below. (AS7)   i. Are resistors 3 and 4 in series? ii. Is the battery in series with any resistor? iii. What is the potential drop across resistor 3? iv. What is the total emf in the circuit if the potential drop across resistor 1 is 6V?",
            "3. A house has 3 tube lights, two fans, and a television. Each tube light draws 40W, each fan draws 80W, and the television draws 60W. On average, all tube lights are kept on for five hours, two fans for 12 hours, and the television for five hours every day. Find the cost of electric energy used in 30 days at the rate of Rs. 3.00 per Kwh. (AS7)"
          ]
          
        },
        {
          chapter: "Chapter 10: Electromagnetism",
          subchapters: [],
          questions : [
            "1. Are the magnetic field lines closed? Explain. (AS1)",
            "2. See fig-Q1, magnetic lines are shown. What is the direction of the current flowing through the wire? (AS1)",
            "3. A bar magnet with the North Pole facing towards a coil moves as shown in fig-Q2. What happens to the magnetic flux passing through the coil? (AS1)",
            "4. A coil is kept perpendicular to the page. At P, current flows into the page, and at Q it comes out of the page as shown in fig-Q3. What is the direction of the magnetic field due to the coil? (AS1)",
            
            "1. The direction of current flowing in a coil is shown in fig-Q4. What type of magnetic pole is formed at the face that has the flow of current as shown in fig-Q4? (AS1)",
            "2. Why does the picture appear distorted when a bar magnet is brought close to the screen of a television? Explain. (AS1)",
            "3. Symbol ‘X’ indicates the direction of a magnetic field into the page. A straight long wire carrying current along its length is kept perpendicular to the magnetic field. What is the magnitude of force experienced by the wire? In what direction does it act? (AS1) (Fig. 5)",
            "4. Explain the working of an electric motor with a neat diagram. (AS1)",
            "5. Explain the working of an AC electric generator with a neat diagram. (AS1)",
            "6. Explain the working of a DC generator with a neat diagram. (AS1)",
            "7. How do you appreciate Faraday’s law, which is a consequence of the conservation of energy? (AS6)",
            "8. The value of magnetic field induction, which is uniform, is 2T. What is the flux passing through a surface of area 1.5m² perpendicular to the field? (AS1)",
            "9. An 8N force acts on a rectangular conductor 20cm long placed perpendicular to a magnetic field. Determine the magnetic field induction if the current in the conductor is 40A. (Ans: 1 tesla) (AS1)",
            "10. As shown in fig-Q4, both coil and bar magnet move in the same direction. What happens? (AS2)",
        ...
        {
          chapter: "Chapter 11:Principles of Metallurgy",
          subchapters: [],
         questions :[
            ...
            "4. What is an ore? On what basis is a mineral chosen as an ore? (AS1)",
            "5. Write the names of any two ores of iron. (AS1)",
            "6. How do metals occur in nature? Give examples of any two types of minerals. (AS1)",
            "7. Write short notes on the froth flotation process. (AS1)",
            "8. When do we use the magnetic separation method for concentration of an ore? Explain with an example. (AS1)",
            "9. Write short notes on each of the following: (AS1)   i) Roasting  ii) Calcination iii) Smelting",
            "10. What is the difference between roasting and calcination? Give one example for each. (AS1)",
            "11. What are gangue and slag? (AS1)",
            "12. Draw the diagram showing i) Froth flotation ii) Magnetic separation. (AS5)",
            "13. Draw a neat diagram of a reverberatory furnace and label it neatly. (AS5)",
            
            "1. Magnesium is an active metal. If it occurs as a chloride in nature, which method of reduction is suitable for its extraction? (AS2)",
            "2. Mention two methods that produce very pure metals from impure metals. (AS2)",
            "3. Which method do you suggest for the extraction of high-reactivity metals? Why? (AS2)",
            "4. What is the activity series? How does it help in the extraction of metals? (AS6)",
            "5. What is the thermite process? Mention its applications in daily life. (AS7)",
            "6. Where do we use handpicking and washing methods in our daily life? Give examples. How do you correlate these examples with the enrichment of ore? (AS7)"
          ],
          
        },
        {
          chapter: "Chapter 12: Carbon and its Compounds",
          subchapters: [],
          questions : [
            ...
            "4. Name the product other than water formed on burning ethanol in air. (AS1)",
            "5. A mixture of oxygen and ethyne is burnt for welding; can you tell why a mixture of ethyne and air is not used? (AS1)",
            "6. Name the simplest ketone and write its molecular formula. (AS1)",
            "7. What do we call the self-linking property of carbon? (AS1)",
            "8. Name the compound formed by heating ethanol at 443 K with excess of conc. H2SO4. (AS1)",
            "9. Give an example for esterification reaction. (AS1)",
            "10. Name the product obtained when ethanol is oxidized by either chromic anhydride or alkaline potassium permanganate. (AS1)",
            "11. Write the chemical equation representing the reaction of preparation of ethanol from ethene. (AS1)",
            "12. What are homologous series of carbon compounds? Mention any two characteristics of homologous series. (AS1)",
            "13. Give the names of functional groups (i) --CHO (ii) --C=O. (AS1)",
            "14. Why does carbon form compounds mainly by covalent bonding? (AS1)",
            "15. Explain how sodium ethoxide is obtained from ethanol? Give chemical equations. (AS1)",
            "16. Explain the cleansing action of soap. (AS1)",
            "17. Distinguish between esterification and saponification reactions of organic compounds. (AS1)",
            "18. Explain the structure of graphite in terms of bonding and give one property based on this structure. (AS1)",
            "19. Name the acid present in vinegar. (AS1)",
            "20. What happens when a small piece of sodium is dropped into ethanol? (AS2)",
            "21. Draw the electronic dot structure of an ethane molecule (C2H6). (AS5)",
            "22. How do you appreciate the role of esters in everyday life? (AS6)",
           
            "1. Give the IUPAC name of the following compounds. If more than one compound is possible, name at least two of them. (AS1)   i. An aldehyde derived from ethane.  ii. A ketone derived from butane.  iii. A chloride derived from propane.  iv. An alcohol derived from pentane.",
            "2. Explain with the help of a chemical equation how an addition reaction is used in the vegetable ghee industry. (AS1)",
            "3. a) What are the various possible structural formulae of a compound having molecular formula C3H6O? (AS1)   b) Give the IUPAC names of the above compounds and write their structures. (AS1)  c) What is the similarity in these compounds? (AS1)",
            "4. Write the IUPAC name of the next higher homologue of CH2OHCH2CH3. (AS1)",
            "5. Allotropy is a property shown by which class of substances: elements, compounds, or mixtures? Explain allotropy with suitable examples. (AS1)",
            "6. Two carbon compounds A and B have molecular formulae C3H8 and C3H6 respectively. Which one of the two is most likely to undergo addition reactions? Justify your answer. (AS2)",
            "7. How do you condemn the use of alcohol as a social practice? (AS7)",
            "8. An organic compound with molecular formula C2H4O2 produces brisk effervescence on the addition of sodium carbonate/bicarbonate. Answer the following:   a) Identify the organic compound. (AS1)   b) Write the chemical equation for the above reaction. (AS1)   c) Name the gas evolved. (AS2)   d) How will you test the gas evolved? (AS3)  e) List two important uses of the above compound. (AS1)",
            "9. 1ml of glacial acetic acid and 1ml of ethanol are mixed together in a test tube. A few drops of concentrated sulphuric acid is added to the mixture and warmed in a water bath for 5 min. Answer the following:   a) Name the resultant compound formed. (AS2)   b) Represent the above change by a chemical equation. (AS1)   c) What name is given to such a reaction? (AS1)   d) What are the special characteristics of the compound formed?"
          ],
      ...
      Biology: [
        {
          ...
          subchapters: [],
          questions : [
            "1. Write differences between autotrophic nutrition - heterotrophic nutrition, ingestion - digestion, light reaction - dark reaction, chlorophyll - chloroplast. (AS1)",
            "2. Give reasons why photosynthesis is considered the basic energy source for most of the living world, why it is right to call the dark phase of photosynthesis as a light-independent phase, why it is necessary to destarch a plant before performing any experiment on photosynthesis, why it is not possible to demonstrate respiration in green plants kept in sunlight. (AS1)",
            "3. Give examples of digestive enzymes, organisms exhibiting heterotrophic nutrition, vitamins, and nutritional deficiency diseases. (AS1)",
            "4. From where do plants get the raw materials required for photosynthesis? (AS1)",
            "5. Explain the process of photosynthesis with the help of a flowchart. (AS1)",
            ...
            "8. In most leaves, the upper surface is more green and shiny than the lower surface. Why? (AS1)",
            "9. Explain the structure of a chloroplast with a neatly labeled sketch. (AS5)",
            "10. What is the role of acid in the stomach? (AS1)",
            "11. Mention the names of glands and organs that help in digestion. (AS1)",
            "12. How is the small intestine designed to assimilate food? Explain. (AS1)",
            "13. How are fats digested? Where do they get digested? (AS1)",
            "14. What is the role of saliva in the digestion of food? (AS1)",
            "15. What will happen to protein digestion as the medium of the intestine is gradually rendered alkaline? (AS1)",
            "16. What is the role of roughages in the alimentary tract? (AS1)",
            "17. What is malnutrition? Explain a few nutritional deficiency diseases. (AS1)",
            "18. How do fungi and bacteria obtain their nourishment? (AS2)",
            "19. If we keep on increasing CO2 concentration in the air, what will happen to the rate of photosynthesis? (AS2)",
            "20. What happens if the rate of respiration is more than the rate of photosynthesis in a plant? (AS2)",
            "21. How can you say that carbohydrates are not digested in the stomach? (AS1)",
            "22. What process do you follow in the laboratory to study the presence of starch in leaves? (AS3)",
            "23. How would you demonstrate that green plants release oxygen when exposed to light? (AS3)",
            "24. Visit a primary health center and collect information about children of different ages suffering from malnutrition. (AS4)",
            "25. Would the survival of organisms become difficult if there were no green plants on Earth? How do you support it? (AS1)",
            "26. Draw the labeled diagram of the human digestive system. List out the parts where peristalsis takes place. (AS5)",
            "27. Raheem prepared a model showing the passage of food through different parts of the alimentary canal. Observe this and label its parts. (AS5)",
            "28. Observe the following diagram and write a note on light-dependent and light-independent reactions. (AS5)",
            "29. What facts about green plants do you appreciate? (AS6)",
            "30. What food habits do you follow after reading this chapter? Why? (AS7)"
          ],
          
        },
        {
          chapter: "Chapter 2: Respiration-The energy producing system",
          subchapters: [],
          questions : [
            "1. Distinguish between inspiration and expiration, aerobic and anaerobic respiration, respiration and combustion, photosynthesis and respiration. (AS1)",
            "2. State two similarities between aerobic and anaerobic respiration. (AS1)",
            "3. Food sometimes enters the windpipe and causes choking. How does it happen? (AS1)",
            "4. Why does the rate of breathing increase while walking uphill at a normal pace in the mountains? Give two reasons. (AS1)",
            "5. Air leaves the tiny sacs in the lungs to pass into capillaries. What modification is needed in the statement? (AS1)",
            "6. Plants photosynthesize during the daytime and respire at night. Do you agree with this statement? Why or why not? (AS1)",
            "7. Why does a deep-sea diver and mountaineer carry an oxygen cylinder on their back? (AS1)",
            "8. How are alveoli designed to maximize the exchange of gases? (AS1)",
            ...
            "10. What is the role of the epiglottis and diaphragm in respiration? (AS1)",
            "11. How does gaseous exchange take place at the blood level or cellular level? (AS1)",
            "12. Explain the mechanism of gaseous exchange at the bronchiole level. (AS1)",
            "13. After vigorous exercise or work, we feel pain in muscles. What is the relationship between pain and respiration? (AS1)",
            "14. Raju said that the stem also respires along with leaves in plants. Can you support this statement? Give your reasons. (AS1)",
            "15. What would happen if the diaphragm was not present in the body? (AS2)",
            "16. If you had a chance to meet a pulmonologist, what questions would you ask about pulmonary respiration? (AS2)",
            "17. What procedure would you follow to understand anaerobic respiration in your school laboratory? (AS3)",
            "18. What are your observations in the combustion of sugar activity? (AS3)",
            "19. Collect information about cutaneous respiration in frogs. Prepare a note and display it in your classroom. (AS4)",
            "20. Collect information about respiratory diseases caused by pollution or tobacco and discuss it with your classmates. (AS4)",
            "21. What is the pathway taken by air in the respiratory system? Illustrate with a labeled diagram. (AS5)",
            "22. Draw a block diagram showing events in respiration. Write what you understood about cellular respiration. (AS5)",
            "23. How do you appreciate the mechanism of respiration in our body? (AS6)",
            "24. Prepare an article on anaerobic respiration to present at a school symposium. (AS7)",
            "25. Prepare a cartoon about a discussion between hemoglobin and chlorophyll regarding respiration."
          ],
        ...
        },
        {
          ...
          subchapters: [],
          questions :[
            "1. What is the transport system? How does it help the organism? (AS1)",
            "2. What is the relationship between blood and plasma? (AS1)",
            "3. Which type of blood vessels carry blood away from the heart? (AS1)",
            "4. What are the three main types of blood vessels in the body? (AS1)",
            "5. Which is the largest artery in the body? Why is it the largest? (AS1)",
            "6. Which blood vessel carries blood for oxidation? (AS1)",
            "7. Name the structures present in veins and lymph ducts that are absent in arteries. (AS1)",
            "8. What is the use of platelets? (AS1)",
            "9. Write differences between systole and diastole, veins and arteries, xylem and phloem. (AS1)",
            "10. Explain how plants absorb water from the soil. (AS1)",
            "11. What is root pressure? How is it useful to the plant? (AS1)",
            "12. Phloem is a food source for some animals. Justify this statement. (AS1)",
            "13. Read the given paragraph and name the parts of the heart. (AS1)",
            "a) The septum that divides the two atria can be named as _____________.",
            "b) The septum that divides the two ventricles can be named as _____________.",
            "c) The septum that divides the atrium and ventricle can be named as _____________.",
            "d) The aperture that connects the right atrium and right ventricle can be named as _____________.",
            "e) The aperture that connects the left atrium and left ventricle can be named as _____________.",
            "f) The valve between the left atrium and left ventricle can be named as _____________.",
            "g) The valve between the right atrium and right ventricle can be named as _____________.",
            "14. If the valves in veins of the legs fail to stop the flow of blood, what could be the consequences? (AS2)",
            "15. What would happen if cell sap in the cells of root hair contained a high concentration of ions? (AS2)",
            "16. John made a stethoscope using a paper cup and plastic tube. Write down the procedure he followed. (AS3)",
            "17. How did scientists prove that food is transported through the phloem? (AS3)",
            "18. What is your inference about experiments with aphids? (AS3)",
            "19. Collect information about the blood pressure of your school teachers or neighbors. Prepare a report on health problems due to changes in blood pressure. (AS4)",
            "20. Draw a block diagram to explain single and double circulation. Write differences between them. (AS5)",
            "21. Prepare a block diagram showing water absorption by roots to transpiration by leaves. (AS5)",
            "22. What can the circulatory system in humans be compared with? (AS6)",
            "23. What is Hemophilia? (AS1)",
            "24. Prepare a cartoon on heart beating. (AS7)",
            "25. After reading this lesson, what precautions would you suggest to your elders about edema? (AS7)"
          ],
        ...
        },
        {
          ...
          questions : [
            ...
            "2. How are waste products excreted in amoeba? (AS1)",
            "3. Name different excretory organs in the human body and the excretory material generated by them. (AS1)",
            "4. Deepak said that ‘Nephrons are functional and structural units of kidneys.’ How would you support him? (AS1)",
            "5. How do plants manage waste materials? (AS1)",
            "6. Why do some people need to use a dialysis machine? Explain the principle involved. (AS1)",
            "7. What is meant by osmoregulation? How is it maintained in the human body? (AS1)",
            "8. Do you find any relationship between the circulatory system and the excretory system? What is it? (AS1)",
            "9. Give reasons: (AS1) A. Why is vasopressin not always secreted? B. Why does urine become alkaline after initially being acidic? C. Why is the diameter of the afferent arteriole larger than that of the efferent arteriole? D. Why is urine thicker in summer than in winter?",
            "10. Write differences between: (AS1) A. Functions of PCT and DCT B. Kidney and artificial kidney C. Excretion and secretion D. Primary metabolites and secondary metabolites",
            "11. A waste product ‘Q’ is formed by protein decomposition in the liver and is filtered in organ ‘P’ by structures called ‘S’. Identify: (AS1) A. Organ P and waste Q B. Artery R and vein T C. Filters S D. Liquid U, structure V, tubes W, and tube X",
            "12. Explain the process of dialysis, using organs ‘A’ and ‘B’ and materials ‘E’, ‘F’, ‘G’, ‘H’, and ‘I’. (AS1)",
            "13. What happens if waste materials are not excreted regularly? (AS2)",
            "14. What questions would you ask a nephrologist about maintaining kidney health? (AS2)",
            "15. What are the gum-yielding trees around you, and how would you collect gum from them? (AS3)",
            "16. Research the uses of various alkaloids, using the library or internet. (AS4)",
            "17. Draw a labeled diagram of the longitudinal section of the kidney. (AS5)",
            "18. Describe the structure of a nephron with a diagram. (AS5)",
            "19. Create a block diagram showing the human excretory pathway. (AS5)",
            "20. Which diagram would you use to explain kidney filtration? (AS5)",
            "21. List aspects of the human excretory system that amaze you. (AS6)",
            "22. What would you discuss after learning about ‘brain death’? (AS6)",
            "23. Write slogans to promote organ donation. (AS7)",
            "24. What habits would you change or adopt for proper kidney function after learning this chapter?"
          ],
        ...
        },
        {
          ...
          subchapters: [],
          questions : [
            "1. Do you think the body’s teamwork maintains the functioning of our body? Justify your answer with an example. (AS1)",
            "2. Give an example of coordination in your body where both hormonal and nervous controls function together. (AS1)",
            "3. Arrange the events in logical order to trace the events that happen in the nervous system from detecting a foul smell to covering your nose: (i) At the end of the axon, electrical impulse releases chemicals.(ii) Stimulus received by the dendrites of a neuron sets off a chemical reaction that creates an electrical impulse.(iii) Electrical impulse transmitted through the cell body and axon.(iv) The chemicals cross the synapse and reach the next neuron. Similarly, the electrical impulse crosses several neurons.(v) Finally, the impulse is delivered from neuron to the gland that helps in recognition of the foul smell and muscle cells that help in covering the nose.",
            "4. What is a synapse? How is it useful in the transfer of information? (AS1)",
            "5. Distinguish between: a) Stimulus and Response b) Afferent and Efferent nerves c) Central nervous system and peripheral nervous system d) Receptor and effector",
            "6. How does phototropism occur in plants? (AS1)",
            "7. Give an example and explain how plants may immediately respond to a stimulus. (AS1)",
            "8. Suggest an experiment to show how roots grow away from light in most plants. (AS1)",
            "9. Give an example to show how hormones can influence visible changes in your body. (AS1)",
            "10. How does a neuron differ from an ordinary cell in structure? Write notes. (AS1)",
            "11. Is the structure of a neuron suitable for transmission of impulses? Analyze. (AS1)",
            "12. Man is the most intelligent animal. What facts help us reach this conclusion? (AS1)",
            "13. Do you support the statement that the axon of a nerve cell in the hand is shorter than that of a nerve cell in the leg? Why? (AS1)",
            "14. Organs respond to external stimuli in a fraction of a second. What are your thoughts on this controlling mechanism of the human body? (AS1)",
            "15. State whether the following actions are voluntary, reflex, or conditioned reflex: (AS1) i) Blinking ii) Cleaning the table iii) Playing on the keyboard iv) Salivating when food is put in the mouth. v) We close our ears when we hear unbearable sound.",
            "16. What will happen to the potted plant kept near a window in the room? (AS2)",
            "17. What happens if all functions of the human body are controlled only by the brain? (AS2)",
            "18. If you visit a doctor, what doubts would you like to clarify about the pancreas? (AS2)",
            "19. Take a small potted plant, cover the base tightly, and hang it upside down. After a week, support your observations on phototropism. (AS3)",
            "20. Take a cock feather and touch it smoothly at different parts of your body. Identify the areas with high sensation. Is this similar during sleep? Prepare a report on it. (AS3)",
            "21. What procedure would you follow to understand the effect of plant growth hormones (in agar medium) on the terminal portion of the stem (coleoptile)? (AS3)",
            "22. Collect information on the actions controlled by the spinal cord using reference books from your school library. (AS4)",
            "23. Compare the following sentences with endocrine glands: (AS4) (a) Pheromones are chemical substances secreted by organisms.(b) These act as chemical signals secreted by exocrine glands.(c) Pheromones are used as signals by members of the same species.(d) Honey bees secrete pheromones that attract other bees to food.",
            "24. Collect information about cranial and spinal nerves from the internet or your school library. (AS4)",
            "25. Draw a picture representing connections between dendrite-dendrite and axon-dendrite. Why do they connect like that? (AS5)",
            "26. Draw a neatly labeled diagram of the brain and write a few points on how it is protected. (AS5)",
            "27. You are walking in traffic when you suddenly hear a loud sound. How does coordination occur in this situation among the respective organs? Draw a block diagram to explain. (AS5)",
            "28. Make a model of a neuron using suitable materials. (AS5)",
            "29. Observe different actions performed by your classmates for 45 minutes. Identify which are controlled by voluntary and involuntary pathways. (AS5)",
            "30. It is interesting to watch a creeper entwining its tendril to support. How do you appreciate this? (AS6)",
            "31. Hormones are released at a specific place, specific time for a specific function. Prepare a cartoon on hormones with a nice caption. (AS7)"
          ],
        ...
        },
        {
          ...
          subchapters: [],
          questions : [
            "I. Why do fish and frogs produce a huge number of eggs each year? (AS1)",
            "II. Give examples and explain what is meant by external fertilisation. (AS1)",
            "III. Write the differences between: (AS1) a) Grafting - Layering b) Stamen - Carpel",
            "IV. Explain the process of fertilisation in plants. (AS1)",
            "V. What are the different modes of asexual reproduction? Cite them with examples. (AS1)",
            "VI. In what ways does sexual reproduction differ from asexual reproduction? State at least three reasons. (AS1)",
            "VII. How are sperm cells adapted for their function? (AS1)",
            "VIII. The menstrual cycle prepares the uterus for a fertilised egg. How long is an average menstrual cycle from start to finish? (AS1)",
            "IX. When the foetus is growing inside the uterus, it needs nutrients. What provides these nutrients? (AS1)",
            "X. Which types of substances are absorbed by the foetus from the mother? (AS1)",
            "XI. What is the job of the amniotic sac? (AS1)",
            "XII. What are the advantages of sexual reproduction? (AS1)",
            "XIII. How does reproduction help in providing stability to the population of a species? (AS1)",
            "XIV. Write the differences between mitosis and meiosis. (AS1)",
            "XV. What happens to the wall of the uterus during menstruation? (AS1)",
            "XVI. Do you support the statement, 'All unicellular organisms undergo only mitotic cell division during favourable conditions'? Why? (AS2)",
            "XVII. Vicky’s father wants to grow a single plant having two desirable characteristics: colourful flowers and big fruits. What method will you suggest to him, and why? (AS3)",
            "XVIII. Uproot an onion plant, take a thin section of its root tip, stain it, and observe under a microscope. Draw as you see and identify the stages of cell division. (AS3)",
            "XIX. Visit a nearby village and collect information on how farmers grow crops like sugarcane, flowering plants like chrysanthemum, and vegetables like stem tubers and ivy gourd. Make a report and present it in class. (AS4)",
            "XX. Collect information from the school library or internet on vegetative propagation methods followed in your district and state. Represent it in a graph. (AS5)",
            "XXI. Make a flowchart to show the cell cycle and explain cell division, describing different stages of mitosis. (AS5)",
            "XXII. Draw neat labelled diagrams of male and female reproductive systems in plants. Prepare a flowchart to explain the process of sexual reproduction in plants. (AS5)",
            "XXIII. Draw a neatly labelled diagram to explain plant fertilisation and write a few points on pollen grains. (AS5)",
            "XXIV. What would be the consequences if there is no meiosis in organisms that reproduce sexually? (AS2)",
            "XXV. How will you appreciate cell division that helps in the perpetuation of life? (AS6)",
            "XXVI. What precautions will you take to keep away from various sexually transmitted diseases? (AS6)",
            "XXVII. Conduct a seminar on child marriages and foeticide. (AS7)"
          ],
        ...
        },
        {
          ...
          subchapters: [],
          questions : [
            "I. What do you mean by hunger pangs? (AS1)",
            "II. What are the organ systems involved in the digestion of the food we eat? (AS1)",
            "III. Rafi said smell also increases our appetite. Can you support this statement? How? (AS1)",
            "IV. Write a note on peristalsis and sphincter function in the stomach. (AS1)",
            "V. Observe the given part of the digestive system. What is it? What is its role during digestion? (AS1)",
            "VI. Give reasons: (AS1) a) If we press our tongue against the palate, we can recognize taste easily.  b) We can’t identify taste when food is very hot.  c) If glucose level falls in the blood, we feel hungry. d) Small intestine is similar to a coiled pipe.  e) Urination increases when we take a lot of fluids. f) The process of digestion goes on in a person whose central nervous system has been largely affected.",
            "VII. Write the difference between the following: (AS1) a) Bolus - Chyme b) Small intestine - Large intestine c) Mastication - Rumination  d) Propulsion - Retropulsion",
            "VIII. How can you say that the mouth is a munching machine? (AS1)",
            "IX. What is mastication? Explain the role of different sets of teeth in this process. (AS1)",
            "X. During the journey of food from the mouth to the stomach through the oesophagus, how does the muscular system coordinate in this process? (AS1)",
            "XI. Is there any reason for the intestine to be coiled with many folds? In what way is it helpful during the process of digestion? (AS1)",
            "XII. What is the function of peristalsis in these parts? (AS1)  a) Oesophagus  b) Stomach c) Small intestine d) Large intestine",
            "XIII. How can you justify the enteric nervous system as the second brain of the gut? (AS1)",
            "XIV. Rajesh feels hungry upon seeing food. Sheela says no to food as she is not hungry. What makes Rajesh hungry and what suppresses Sheela’s hunger? (AS1)",
            "XV. How are taste and smell related? (AS1)",
            "XVI. List out the sphincter muscles of the food canal you have observed and give a brief description. (AS1)",
            "XVII. What experiment should you perform to understand the action of saliva on flour? Explain its procedure and the apparatus you followed. (AS3)",
            "XVIII. What happens if salivary ducts are closed? (AS2)",
            "XIX. If the size and shape of the small intestine were like that of the oesophagus, what would happen? (AS2)",
            "XX. Prepare a questionnaire to understand nervous coordination in the digestion process. (AS2)",
            "XXI. Suggest a simple experiment to prove the role of the palate in recognizing taste. (AS3)",
            "XXII. Collect information related to feeling hunger from your school library and prepare a note on it. (AS4)",
            "XXIII. Draw a block diagram showing the sensation of taste from food material to the brain. (AS5)",
            "XXIV. Draw a neatly labeled diagram showing peristaltic movement in the oesophagus. Explain the importance of mucus on the walls of the food pipe. (AS5)",
            "XXV. Draw a schematic diagram of villus in the small intestine. Explain how the digestive system coordinates with the circulatory system. (AS5)",
            "XXVI. The mere smell or sight of food stimulates hunger. Describe the process through a neat diagram. (AS5)",
            "XXVII. With the help of a diagram, show the movement of food from the mouth to the stomach. What muscles and nerves are involved in the movement of food, and what is this action called? (AS5)",
            "XXVIII. Prepare a cartoon on Pavlov’s experiment with a suitable caption. (AS6)",
            "XXIX. How do you appreciate the stomach as a churning machine? How does this coordination go on? (AS6)",
            "XXX. There is a great variety in diversified life processes. Express your feelings in the form of a poem. (AS7)",
            "XXXI. Suggest any two important habitual actions to your friend while eating food, based on this chapter."
          ],
        ...
        },
        {
          ...
          subchapters: [],
        questions : [
            "I. What are variations? How do they help organisms? (AS1)",
            "II. One student (researcher) wants to cross a pure tall plant (TT) with a pure dwarf (tt) plant. What would be the F1 and F2 generations? Explain. (AS1)",
            "III. One experimenter cut the tails of parent rats. What could be the traits in offspring? Do the daughter rats contain tails or not? Explain your argument. (AS1)",
            "IV. In a mango garden, a farmer saw one mango tree full of mango fruits but with a lot of pests, and another mango tree without pests but with few mangoes. The farmer wants a mango tree with full of mango fruits and pest-free. Is it possible to create a new mango tree as the farmer wants? Explain how it is possible. (AS1)",
            "V. Explain a monohybrid experiment with an example. Which law of inheritance can we understand? Explain. (AS1)",
            "VI. What is the law of independent assortment? Explain with an example. (AS1)",
            "VII. Explain Darwin’s theory of evolution, ‘Natural selection,’ with an example. (AS1)",
            "VIII. What are variations? Explain with a suitable example. (AS1)",
            "IX. What variations have you generally observed in the species of cows? (AS1)",
            "X. What are the characters Mendel selected for his experiments on pea plants? (AS1)",
            "XI. In what way did Mendel use the word ‘Traits’? Explain with an example. (AS1)",
            "XII. What differences did Mendel identify between parent and F2 generation? (AS1)",
            "XIII. Male is responsible for sex determination of a baby – do you agree? If so, write your answer with a flow chart. (AS1)",
            "XIV. Write a brief note on analogous organs. (AS1)",
            "XV. How do scientists utilize the information about fossils? (AS1)",
            "XVI. Mendel selected a pea plant for his experiments. Mention the reasons in your point of view. (AS2)",
            "XVII. If the theory of inheritance of acquired characters proposed by Lamark was true, how would the world be? (AS2)",
            "XVIII. Collect information on inherited traits in your family members and write a note on it. (AS4)",
            "XIX. Observe flowering plants in your surroundings. Write similarities and differences between them.",
            "XX. Write your comments on evidence of evolution with the following information: 'Mammals have four limbs, as do birds, reptiles, and amphibians. The basic structure of the limbs is...' (AS4)",
            "XXI. Collect information about the carbon dating method. Discuss it with your physical science teacher.",
            "XXII. Draw a checkerboard to show the law of independent assortment with a flow chart and explain the ratio. (AS5)",
            "XXIII. Explain the process to understand the monohybrid cross of Mendel’s experiment with a checkerboard. (AS5)",
            "XXIV. Prepare a flow chart showing the evolution of man through ages. (AS5)",
            "XXV. Nature selects only desirable characters. Prepare a cartoon. (AS6)",
            "XXVI. What is your understanding of 'survival of the fittest'? Give some situations or examples that you observe in your surroundings. (AS7)",
            "XXVII. Write a monologue on the evolution of man to perform a stage show on theatre day at your school. (AS7)"
          ],
        ...
        {
          chapter: "Chapter 9: Our environment - Our concern",

          subchapters: [],
          questions : [
            "I. What happens to the amount of energy transferred from one trophic level to the next in a food chain? (AS1)",
            "II. What do pyramids and food chains indicate in an ecosystem? (AS1)",
            "III. Write a short note on the pyramid of numbers for any food chain. What did you conclude from the pyramid of numbers drawn using: (i) tree, (ii) insects, (iii) woodpecker? (AS1)",
            "IV. Draw the pyramid of biomass using the terms given below: (i) grass, (ii) herbivores, (iii) predators, (iv) hawk. (AS5)",
            "V. How does the usage of toxic substances affect an ecosystem? Write a short note on bioaccumulation and biomagnification. (AS1)",
            "VI. Should we use pesticides to protect the crops and foods from pests? Or should we think of alternatives? Write your opinion and the reasons for it. (AS1)",
            "VII. What is a trophic level? What does it represent in an ecological pyramid? (AS1)",
            "VIII. If you want to know more about the flow of energy in an ecosystem, what questions do you ask? (AS2)",
            "IX. What will happen if we remove predators from the food web? (AS2)",
            "X. Observe a plant in your kitchen garden and write a note on the producer-consumer relationship. (AS3)",
            "XI. Collect information on laws and ethics concerned with the environment and display it on the bulletin board. (AS4)",
            "XII. Draw a pyramid of numbers considering yourself as a top-level consumer. Write about the lower trophic levels. (AS5)",
            "XIII. Prepare slogans to promote awareness in your classmates about eco-friendly activities. (AS7)",
            "XIV. Suggest any three programs on avoiding pesticides and preventing soil pollution."
          ],
        ...
        },
        {
          ...
          questions : [
              ...
              "I. The BP Statistical Review of World Energy measured total global oil at 188.8 million tonnes from proved oil resources at the end of 2010, indicating oil would last for 46.2 years. What measures should be taken to conserve oil? What will happen if we do not conserve it? (AS1)",
              "II. Read the news strip and answer the following questions about the villagers opposing a sand mining project in Santhabommali, Srikakulam:    i) Do you think the villagers are doing the right thing by agitating? Why?   ii) What resources are the villagers trying to save?   iii) Will the villagers benefit from the rich minerals extracted from the sand?   iv) Why does the private company want to mine in the beach area?  v) What is the role of the government in this matter?   vi) How will mining in that area affect the local population?",
              "III. What is sustainable development? How is it useful in natural resource management? (AS1)",
              "IV. Write a detailed note on the management of a natural resource. (AS1)",
              "V. Suggest some ways to reuse resources in your locality. (AS1)",
              "VI. Why should we conserve forests and wildlife? (AS1)",
              "VII. Suggest some approaches for the conservation of forests. (AS1)",
              "VIII. Natural resources are decreasing rapidly. What do you think will be the consequences? (AS2)",
              "IX. Prepare a questionnaire to interview personnel at a petrol station about fossil fuel consumption. (AS2)",
              "X. Create a model for rainwater harvesting, energy saving, or soil management that reflects your innovative ideas. (AS3)",
              "XI. List the names of farmers and describe the procedures used for the restoration of any natural resource in your area.",
              "XII. Collect information on the status of gas production near Kakinada by ONGC and prepare a note. (AS4)",
              "XIII. Does your village or nearby city have a recycling unit for waste materials? Write about the steps involved. (AS4)",
              "XIV. Find a graph showing oil (petroleum) consumption in India and answer the following  i) Does production meet consumption in India?   ii) During which period did consumption increase the most?   iii) What changes occurred in production from 2006-2016?  iv) Suggest ways to reduce petroleum consumption.",
              "XV. Proper utilization of natural resources shows gratitude to our nation. Do you agree? Explain your argument. (AS6)",
              "XVI. Create a slogan to raise awareness among farmers about selecting crops based on water availability."
            ],
      ...
      Social_Science: [
        {
          ...
          subchapters: [],
          questions : [
            "I. The sun rises two hours earlier in Arunachal Pradesh compared to Gujarat in the west. But the clocks show the same time. How does this happen? (AS1)",
            "II. If the Himalayas weren’t situated where they are now, how would the climatic conditions of the Indian subcontinent be? (AS1)",
            "III. What are the major physiographic divisions of India? Contrast the relief of the Himalayan region with that of the peninsular plateau. (AS1)",
            "IV. What is the influence of the Himalayas on Indian agriculture? (AS1)",
            "V. The Indo-Gangetic plains have a high population density. Why? (AS1)",
            "VI. On an outline map of India, show the following: (AS5)  i) Mountain and hill ranges – the Karakoram, the Zaskar, the Patkai Bum, the Jaintia, the Vindhya range, the Aravali, and the Cardamom hills.  ii) Peaks – K2, Kanchenjunga, Nanga Parbat, and Anaimudi.  iii) Plateaus - Chotanagpur and Malwa.   iv) The Indian Desert, Western Ghats, and Lakshadweep Islands.",
            "VII. Using an atlas, identify the following:   i) Islands formed due to volcanic eruption   ii) Countries constituting the Indian subcontinent  iii) States through which the Tropic of Cancer passes. iv) The northernmost latitude in degrees. v) The southernmost latitude of the Indian mainland in degrees.  vi) The easternmost and westernmost longitudes in degrees.   vii) The place situated on three seas.  viii) The strait separating Sri Lanka from India.   ix) The Union Territories of India. x) The states where the Himalayas extend.",
            "VIII. Compare the Eastern and Western coastal plains. How are they similar or different? (AS1)",
            "IX. Why do plateau regions in India support agriculture less than plain regions? (AS1)",
            "X. Prepare a detailed table comparing the Himalayas, Islands, and Coastal Plains. (AS3)",
            "XI. “The Himalayas play a vital role in India’s development.” Comment. (AS2)"
          ],
        ...
        },
        {
          ...
          subchapters: [],
          questions : [
            "What is the main criterion used by the World Bank in classifying different countries? What are the limitations of the above criterion, if any? (AS1)",
            "Usually behind each social phenomenon, there would be several contributing factors, and not one. What factors that came together for the development of schooling in Himachal Pradesh? (AS1)",
            ...
            "Do you think there are certain other aspects, other than those discussed in the chapter, that should be considered in measuring human development? (AS4)",
            "Why do we use averages? Are there any limitations to their use? Illustrate with your own examples related to development. (AS1)",
            "What lessons can you draw about the importance of income that Himachal Pradesh with lower per capita income has a better human development ranking than Haryana? (AS1)",
            "Based on the figures in Table 6, fill the following: Out of every 100 girls above 6 years of age, ______ girls had studied beyond the primary level in Himachal Pradesh in the year 1993. By the year 2006, this proportion reached _____ out of 100. For India as a whole, the proportion of boys who had studied beyond primary level was only _____ out of 100 in the year 2006. (AS3)",
            "What is the per capita income of Himachal Pradesh? Do you think higher incomes can make it easier for parents to send children to school? Discuss. Why was it necessary for the government to run schools in Himachal Pradesh? (AS1)",
            "Why do you think do parents accord less priority to girls' education as compared to boys? Discuss in the class. (AS4)",
        ...
        },
        {
          ...
          subchapters: [],
           questions : [
            "Do you think the classification of economic activities into primary, secondary and services sectors is useful? Explain how. (AS1)",
            "For each of the sectors that we came across in this chapter, why should one focus on employment and GDP? Could there be other issues which should be examined? Discuss. (AS4)",
            "How is the service sector different from other sectors? Illustrate with a few examples. (AS1)",
            "What do you understand by underemployment? Explain with one example each from the urban and rural areas. (AS1)",
            "The workers in the unorganised sector need protection on the following issues: wages, safety and health. Explain with examples. (AS1)",
            ...
            "Read the 4th para of page 33, i.e. 'In the past 50 years, ............. observed for developed countries'. Is a similar pattern observed for India? Give your opinion. (AS2)",
            "Observe the ‘pie’ graphs given in page 34 and answer the following questions. (AS3) i) In the year 2015-16, in G.D.P. share of which sectors are increased when compared to the year 1973-74? ii) How much the share of agricultural sector in GDP is decreased in the year 2015-16 when compared to the year 1973-74.",
            "What points are to be considered while estimating gross domestic product? (AS1)",
            "Discuss the changes in shares of different sectors in GDP. (AS1)",
        ...
        },
        {
          ...
          subchapters: [],
       questions : [
            "Read the following statements and find out whether they are an example of weather or climate (AS1) a) During the last few years, many glaciers have melted in Himalayas. b) During the last few decades, drought in Vidarbha region has increased.",
            "Describe India’s climate controls. (AS1)",
            "Write a short note on factors influencing climatic variations in hilly areas and deserts. (AS1)",
            "How are human activities contributing to global warming? (AS4)",
            "What are the disagreements between ‘developed’ and ‘developing’ countries about AGW? (AS1)",
            "How is climate change causing global warming? Suggest measures to minimize the influence of global warming. (AS4)",
            "Observe the following climograph and answer the questions below. (AS3) A. Which month received the highest rainfall B. Which months experience the highest and the lowest temperature? C. Why does the maximum amount of rainfall happen between June and October? D. Why is the temperature high between March and May? E. Identify relief conditions causing variation in temperature and rainfall."
          ],
        ...
        },
        {
          ...
          subchapters: [],
          questions : [
            "Draw a table to describe the major river systems in India with the following items: direction of flow, countries or regions through which they pass, and relief features of the areas. (AS3)",
            "Identify and list arguments that would support or oppose the use of groundwater in various contexts such as agriculture, industry, etc. (AS2)",
            "Make a list of challenges faced in the water resources in the Tungabhadra basin. Identify the solutions that have been discussed in the context of these problems either in this chapter or elsewhere in different classes. (AS4)",
            "Which aspects of farming practices were regulated in the context of Hiware Bazar to improve water conservation? (AS1)",
            "How significant are the laws and people’s actions, in the context of water resources? Write a short note based on the ideas discussed in the last two sections of the chapter. (AS1)",
            "In what ways is water bought and sold in your area and for what purposes? Do you think there should be some checks and balances for this? Discuss. (AS4)",
            "Availability of water is decreasing day by day, and groundwater levels are falling. How will this affect our lives if the situation continues? Discuss preventive measures and our responsibility."
          ],
        
          
        },
        {
          chapter: "Chapter 6: The Population",
         questions : [
            "List out the impacts on society if the sex ratio is too low or too high. (AS4)",
            "Compare Indian literacy rates with other countries: Sri Lanka, Nepal, Bangladesh, Myanmar, Pakistan. What similarities and differences do you note? (AS1)",
            "Which areas of Telangana have a high density of population, and what may be some of the reasons behind it? (AS1)",
            "Distinguish between population growth and population change. (AS1)"
          ]
        ...
        {
          chapter: "Chapter 7: Settlement and Migration",
        questions : [
            "What is a settlement? (AS1)",
            "How has human lifestyle changed with settlements? (AS1)",
            "How does the Census of India define various kinds of places? How does it organize them in order of size and other characteristics? (AS1)",
            "What is an aerotropolis? How is it structured? (AS1)",
            "Read the last para of page 99 'When families migrate ...... many of them become dropouts', and comment on it. (AS2)",
            "Compare and contrast the migration from rural to urban areas and rural to rural areas. (AS1)",
            "Do you think migrants are trouble makers/trouble shooters in their destinations? Justify your answer. (AS4)",
            "How does rural to urban migration increase the purchasing power of people in rural areas? (AS1)",
            "Why are only professionals able to go to developed countries? Why cannot unskilled workers migrate to these countries? (AS1)",
            "Describe the similarities and differences between the impacts of internal and international migration. (AS1)",
            "Locate the following in the map of India: a) Chennai b) Bengaluru c) Delhi d) Hyderabad e) Kolkata (AS5)"
          ],
        ...
        {
          chapter: "Chapter 8:  Rampur : A Village Economy",
          subchapters: [],
          questions : [
            "Why are the wages for farm labourers in Rampur less than minimum wages? (AS1)",
            "Talk to two labourers from your region. Choose either farm labourers or labourers working at construction sites. What wages do they get? Are they paid in cash or kind? Do they get work regularly? Are they in debt? (AS3)",
            "What are the different ways of increasing production on the same piece of land? Use examples to explain. (AS1)",
            "How do medium and large farmers obtain capital for farming? How is it different from the small farmers? (AS1)",
            "On what terms did Savita get a loan from Tejpal? Would Savita's condition be different if she could get a loan from the bank at a low rate of interest? (AS1)",
            "Talk to some elderly persons in your region and write a small report on the changes in irrigation and changes in production methods during the last 30 years. (AS3)",
            "What are the main non-farm production activities taking place in your region? Write a brief report on any one such activity. (AS3)",
            "Imagine a situation where labour is the scarce factor of production instead of land. Would the story of Rampur be different? How? Discuss in class. (AS1)",
            "Gosaipur and Majauli are two villages in North Bihar. Out of a total of 850 households in the two villages, there are more than 250 men who are employed in rural Punjab and Haryana or in Delhi, Mumbai, Surat, Hyderabad, or Nagpur. Such migration is common in most villages across India. Why do people migrate? Can you describe (based on your imagination and previous chapter) the work that the migrants of Gosaipur and Majauli might do at the place of destination? (AS4)",
            "Land is also required for production of goods in an urban area. In what ways is the use of land different from a rural area? (AS1)",
            "Read again the meaning of 'land' in the production process. Give three examples, other than agriculture, where this requirement is most significant in the process of production. (AS1)",
            "Water, a natural resource for production, particularly agricultural production, now requires greater capital for its use. What is your opinion on it? (AS2)"
          ],
        ...
        {
          chapter: "Chapter 9: Globalisation",
          questions :[
            "What were the reasons for putting barriers to foreign trade and foreign investment by the Indian government? Why did it wish to remove these barriers? (AS1)",
            "How would flexibility in labour laws help companies? (AS1)",
            "What are the various ways in which MNCs set up or control production in other countries? (AS1)",
            "Why do developed countries want developing countries to liberalise their trade and investment? What do you think should the developing countries demand in return? (AS4)",
            "The impact of globalisation has not been uniform. Explain this statement. (AS1)",
            "How has liberalisation of trade and investment policies helped the process of globalisation? (AS1)",
            "Globalisation will continue in the future. Can you imagine what the world would be like twenty years from now? Give reasons for your answer. (AS4)",
            "Locate the following on the world map: i) China ii) Japan iii) Brazil iv) South Africa (AS5)"
          ],
          
        },
        {
          chapter: "Chapter 10: Food Security",
          subchapters: [],
           questions : [
            "Suppose that the foodgrain production has been affected in a particular year because of a natural calamity. In what ways can the government ensure higher availability of foodgrains for the year? (AS4)",
            "Use an imaginary example from your context to describe the relationship between underweight and access to food. (AS4)",
            "Analyse a week’s food habits of your family. Create a table to explain nutrition elements included in it. (AS3)",
            "Describe the relationship between increase in food production and food security. (AS1)",
            "Give reasons to argue for the following statement: 'Public Distribution System can ensure better food security for people.' (AS1)",
            "Make similar posters about food security. (AS6)",
            "Read the last para of page 137 i.e.; 'Studies indicate............ for access', and write your opinion. (AS2)",
            "Locate the following on the map of India: i) Karnataka ii) Odisha iii) Gujarat iv) Maharashtra v) Madhya Pradesh vi) West Bengal vii) Chhattisgarh viii) Telangana ix) Uttar Pradesh x) Punjab (AS5)"
          ],
          
        },
        {
          chapter: "Chapter 11: Sustainable Development with Equity",
          subchapters: [],
           questions : [
            ...
            "“Last, but not the least, the key to environmental problem lies in changing lifestyles that will minimise waste and pollution.” (AS4)",
            "What are the various ways in which our lifestyles affect the environment? Use examples from your own context to explain.",
            ...
            "Locate i) The River Narmada ii) Sardar Sarovar project in the map of India. (AS5)"
          ],
          
        },
        {
          chapter: "Chapter 12: The World During the World Wars",
          subchapters: [],
           questions : [
            "Make a table to show allies, axis and central powers, participated with following countries on different sides of the world wars: Austria, USSR (Russia), Germany, Britain, Japan, France, Italy, USA. (AS3)",
            "How did the idea of nation states and nationalism influence desire for war during World Wars? (AS1)",
            "Write a short note on various causes of two World Wars. Do you think any of these features are prevalent even today in countries around the world? How? (AS4)",
            "Russian revolution brought in many changes in their society. What were they? And what challenges did they face? (AS1)",
            "Compare different points of view about Great Depression, which one would you agree with? Why? (AS1)",
            "In what ways were Jews persecuted during the Nazi Germany? Do you think in every country some people are differentiated because of their identity? (AS4)",
            "List the measures taken under idea of welfare state under Great Depression. (AS1)",
            "What challenges were faced by Germany during Great Depression and how did Nazi rulers and Hitler make use of it? (AS1)",
            "Read the para 1 of page 169 i.e; “This started a great experiment ......... language, etc” and write your opinion on it. (AS2)",
            "Observe the map-2 of page 181 and answer the following questions. (AS5)",
            "Mention any two countries which are not under the control of Japan.",
            "Mention any two countries which are under the control of Japan and lying on its western side.",
            "Locate the following in the map of the world. (AS5)i) Germany ii) Italy iii) Austria iv) U.S.A. v) China vi) Russia vii) Britain",
            "Prepare a few slogans on the prevention of wars and promotion of peace. (AS6)"
          ],
          
        },
        {
          chapter: "Chapter 13: National Liberation Movements in the Colonies",
          subchapters: [],
           questions : [
            "Trace the changes in the role of women seen in China over the decades. Why is it similar or different from that of USSR and Germany? (AS1)",
            "After the overthrow of monarchy, China had two different types of regimes. How were they similar or different? (AS1)",
            "Countries discussed in the chapter were all mostly dependent on agriculture. What were the measures taken in these countries to change these practices? (AS1)",
            "Who owned industries in countries discussed above and what policies were brought in to change the systems? Make a table to compare them. (AS1)",
            "Compare the national movement in India and Nigeria - can you explain why it was stronger in India? (AS1)",
            "What are the challenges faced by the independent Nigerian nation? In what ways is it similar or different from the challenges faced by independent India? (AS1)",
            "Unlike Vietnam or India, Nigeria did not have to struggle so hard for freedom. Can you find some explanations for this? (AS1)",
            "What role did schooling play in national movement of the countries discussed above? (AS6)",
            "Freedom struggle in these countries involved wars against the rulers. Briefly describe its impact. (AS1)",
            "Read page 193 the first five lines of the para under the title ‘the civilizing mission’ and say, how do you agree with it? Why? (AS2)"
          ],
          
        },
        {
          chapter: "Chapter 14: National Movement in India – Partition & Independence : 1939-1947",
          subchapters: [],
           questions : [
            "Make a table and show how different groups, and individuals in India responded to World War II. What dilemmas were faced by these groups? (AS1)",
            "Given the brutal manner in which particular communities like Jews and others were treated in Germany, do you think it would have been morally right to support Germany or Japan? (AS1)",
            "Make a list of various reasons for the Partition of the country. (AS1)",
            "What were the different ways in which power sharing among different communities was organised before Partition? (AS1)",
            "How did British colonialists practice their ‘divide and rule’ policy in India? How was it similar or different from what you have studied about Nigeria? (AS1)",
            "What were the different ways in which religion was used in politics before Partition? (AS1)",
            "How were workers and peasants mobilised during the last years of freedom struggle? (AS1)",
            "How did Partition affect the lives of ordinary people? What was the political response to mass migration following Partition? (AS1)",
            "Integration of various princely states into the new Indian nation was a challenging task. Discuss. (AS1)",
            "Locate the following in the political map of India: a) Kashmir b) Hyderabad c) Junagarh d) Bengal e) Travancore (AS5)",
            "Which qualities do you like in Subhash Chandra Bose? Why. (AS6)"
          ],
          
        },
        {
          chapter: "Chapter 15: The Making of Independent India’s Constitution",
          subchapters: [],
           questions : [
            "Find the odd one out: (AS1)\nIndian Constitution adopts from experiences of freedom struggle\nIndian Constitution adopts from already existing constitutions\nIndian Constitution has remained the same since its drafting\nIndian Constitution provides principles and provisions for ruling the country",
            "Correct the false statements: (AS1)\nThere was unanimity of opinion on all provisions during CA debates\nThe makers of Constitution represented only certain regions of the country\nConstitution provides certain provisions to amend articles in it\nSupreme Court of India has said that basic features of Constitution may also be amended",
            "Describe the unitary and federal principles of Indian government as discussed in the CA debates. (AS1)",
            "How does the Constitution reflect the political events of the time? Draw from previous chapters on freedom struggle. (AS1)",
            "What difference would it have made to the making of our Constitution if the Assembly had been elected through universal adult franchise? (AS1)",
            "Write a short note on basic principles of Indian Constitution. (AS1)",
            "How has the Constitution defined and changed political institutions in the country? (AS1)",
            "While Constitution provides basic principles it is the engagement of people with the system that brings in social change. Do you agree with this statement, give reasons. (AS1)",
            "Locate the following on the map of the world: a) Nepal b) Japan c) Delhi d) USA (AS5)",
            "Observe the Bar graph given in page 230 and answer the following questions. (AS3)\n i) In which year the most number of constitutional amendments took place?\n ii) How many more number of amendments took place in the decade 1971-80 when compared to 1961-70?",
            "Prepare a pamphlet on the implementation of equality in your school. (AS6)"
          ],
          
        },
        {
          chapter: "Chapter 16: The Election Process in India",
          subchapters: [],
           questions : [
            "How can you say that right to vote plays a key role in democracy? (AS1)",
            "Estimate the role of Election Commission in India. (AS1)",
            "Define the functions of the Election Commission. (AS1)",
            "What is the necessity of model code of conduct in a democracy? (AS1)",
            "Our responsibility does not end with casting the vote. To protect the democracy, we should always be alert. Support. (AS1)",
            "Have you ever observed any malpractices in the elections of your area? Which rule of Code of Conduct was violated? (AS4)",
            "Read the paragraph under “Need for election reforms” and comment. (AS2)",
            "Prepare a pamphlet creating awareness about the importance of voting. (AS6)"
          ],
          
        },
        {
          chapter: "Chapter 17: Independent India (The First 30 years - 1947-77)",
          subchapters: [],
           questions : [
            "What measures were taken to bring in socio-economic change during the initial years after independence? (AS1)",
            "What do you understand about one party dominance? Would you consider it as dominance only in elections or also in terms of ideology? Discuss with reasons. (AS1)",
            "Language became a central rallying point in Indian politics on many occasions, either as a unifying force or as a divisive element. Identify these instances and describe them. (AS1)",
            "What were the major changes in the political system after the 1967 elections? (AS1)",
            "Think of the other ways in which states could have been created and how would they be better than language-based reorganisation. (AS1)",
            "What measures of Indira Gandhi are called 'left turn'? How do you think this was different from policies of the previous decades? Based on the knowledge gained from the economics chapters, describe how it is different from the current policies. (AS1)",
            "In what ways was the Emergency period a setback to Indian democracy? (AS1)",
            "What were the institutional changes that came up after the Emergency? (AS1)",
            "Locate the following on the map of India. (AS5) a) Maharashtra b) Gujarat c) Bihar d) Uttar Pradesh e) Jammu-Kashmir f) Nagaland g) Punjab h) Meghalaya",
            "Analyse the advantages and problems faced by the people due to the multiparty system in India. (AS4)",
            "Read the para 2 of page 242 and comment on it. (AS2)"
          ],
          
        },
        {
          chapter: "Chapter 18: Emerging Political Trends 1977 to 2000",
          subchapters: [],
           questions : [
            "Identify the major changes in the party system during the second phase of Independence. (AS1)",
            "What are the major economic policies of various governments at the centre and the state discussed in this and the previous chapters? How are they similar or different? (AS1)",
            "How did regional aspirations lead to the formation of regional parties? Compare the similarities and differences between the two different phases. (AS1)",
            "In order to form governments, it becomes necessary for political parties to attract people from different sections of society. How did different political parties realise these objectives in the second phase after independence? (AS1)",
            "What were the developments that weakened the inclusive nature of Indian polity? How is the ability to accommodate different communities and regional aspirations changing? (AS1)",
            "How do different types of regional aspirations draw from cultural and economic dimensions? (AS1)",
            "In the first half of the period after independence, there was a lot of importance given to planned development. In the later part, emphasis was given to liberalisation. Discuss and find out how this reflects political ideals. (AS1)",
            "Study the newspapers and magazines to identify at least one example each of moderation in policies due to coalition and how do different political parties in coalition emphasise their regional demands? (AS3)",
            "Prepare an album by collecting the photos of Prime Ministers of India and write their specialities. (AS3)",
            "Read the para under the title 'Andhra Pradesh' from 'In combined Andhra Pradesh ........ office of the congress party' of page 262 and comment on it. (AS2)",
            "What are the effects of changes of 'Telecom Revolution' on the Human lifestyles? (AS4)"
          ],
          
        },
        {
          chapter: "Chapter 19: Post - War World and India",
          subchapters: [],
           questions : [
            "Choose the correct answer: Which among the following statements about the Cold War is wrong? a) Rivalry between US and USSR. b) USA and USSR engaged in direct war. (AS1) c) Triggering off an arms race. d) An ideological war between the two super powers.",
            "Who amongst the following is not involved in the West Asian crisis? (AS1) a) Egypt b) Indonesia c) Britain d) Israel",
            "What was the nature of shift in power in the world after the second world war? (AS1)",
            "What are the different roles played by the United Nations in order to build peace in the world? (AS1)",
            "Given the idea of democracy, do you think a few countries should have special powers in making the decisions? (AS2)",
            "How were the superpowers benefited by military alliances? (AS1)",
            "How did the Cold War produce arms race as well as arms control? (AS1)",
            "Why did West Asia become a center of tensions in the world? (AS1)",
            "By the end of the 20th century, there is only one single power that dominates the world. In this context, what do you think would be the role of NAM? (AS1)",
            "Formation of NAM was not merely in the context of military alliances but also in the context of economic policies. Justify the statement. (AS1)",
            "Draw a table to show the relations between India and its neighbouring countries with regard to the following items: issues of conflict; events of war; events of help and co-operation. (AS3)",
            "The ethnic conflicts affected India’s relations with Sri Lanka. Justify. (AS1)",
            "Locate the following on the map of the world. (AS5) i) Poland ii) USSR iii) Vietnam iv) Spain v) Latin America vi) Afghanistan",
            "Observe the graph-2 of page 288 and answer the following. (AS3) i) Which country’s military expenditure is high ii) What do you observe in the military expenditures of the two countries as a percent of GDP?",
            "Read the last para of page 285 and comment on it. (AS2)"
          ],
          
        },
        {
          chapter: "Chapter 20:Social Movements in Our Times",
          subchapters: [],
          questions : [
            "Here is a list of items that you can use to make a table on social movements. Find out the similarities and differences between the different movements: (AS3) Main area of focus of the movement; location; main demands; modes of protest; important leaders; response from the state; possible impact on society.",
            "Kannaiah, Ramya and Salma have a debate. Ramya argues it is okay to restrict the freedom of press etc but ensure that people do not live in poverty. Salma argues that food alone is not important. It is equally important to have freedom of press because there is no other way people would know if there is violation of dignity of people in different parts of the country. Kannaiah says that how will it make a difference if press belongs to the rich and powerful people, why would they cover things that ordinary people expect. They have different expectations. Whom would you agree with and give reasons, from the context of human rights? (AS2)",
            "What are the basic features of a social movement? (AS1)",
            "What is the role of ordinary individuals described in the case studies given in the chapter? (AS1)",
            "How are the rights of black people in USA and Meira Paibi movements similar or different? (AS1)",
            "Democracies have been identified as the most prominent political systems across the world. Do you think democracy has been able to take care of all the expectations of people? Based on the examples cited in these chapters, write a short note on ‘democracy and social movements’. (AS4)",
            "Discuss and find out how movements mobilise people from across the globe like in the above instance of campaign to protest in the context of Bhopal gas tragedy. (AS3)"
          ],
          
        },
        {
          chapter: "Chapter 21: The Movement for the Formation of Telangana State",
          subchapters: [],
          questions : [
            "Correct the incorrect statements (AS1) Indian states were formed based on languages. Sufficient recognition has been provided to languages of all different groups of people living in the state.",
            "“Diversity of people living in Telangana has historical, social and cultural context.” Justify the statement based on arguments given in the chapter. (AS2)",
            "Describe the main features of Gentleman’s Agreement. How did this become a point of distrust between the regions? (AS1)",
            "Based on the experiences of people’s aspiration in Telangana, what measures of safeguards would you take to ensure that all sections of people living in the region feel respected? (AS4)",
            "What have been the differences in access to water, agriculture, education and employment in the two regions? (AS1)",
            "How did the disparity of growth between urban areas and agriculture create conflict of interest in expectations from the government? (AS1)",
            "What arguments were put forward by people who wanted the two regions to be united? (AS1)",
            "How do you evaluate the various modes of mobilisation methods used in Telangana state formation? (AS1)",
            "Describe the different roles taken up by JACs and Political parties in the formation of Telangana state? How do you think JACs created a platform across political ideologies? (AS1)",
            "Locate the following in the map of Telangana. (AS5) i) Mahabubnagar ii) Khammam iii) Nizamabad iv) Adilabad v) Nalgonda vi) Mahaboobabad vii) Nirmal viii) Jogulamba"
          ],
      ...
      Physics: [
        {
          ...
          subchapters: [],
           questions : [
              "A unit used for measuring very large distances is called a light year. It is the distance covered by light in one year. Express light year in metres. Take speed of light as 3 × 10^8 m s–1.",
              "State the number of significant figures in the following: (a) 5769 (b) 0.042 (c) 0.08420 (d) 6.033 (e) 3.56 × 10^8.",
              "A stick has a length of 12.132 cm and another has a length of 12.4 cm. (a) If the two sticks are placed end-to-end what is the total length? (b) If the two sticks are placed side-by-side, what is the difference in their lengths?",
              ...
              "Newton’s law of gravitation states that the magnitude of force between two particles of mass m1 and m2 separated by a distance r is given by F = (G * m1 * m2) / r^2 where G is the universal constant of gravitation. Find the dimensions of G.",
              "Explain the different types of errors that can occur in measurements.",
              "Distinguish between fundamental and derived units.",
              "What is meant by significant figures in measurement?",
            "Define physical quantity. Provide examples.",
            ...
            "Explain the concept of dimensional analysis and its uses.",
            "How do you perform the dimensional check for a given equation?",
            "What are the advantages of using the SI system of units?",
            "Explain the term 'significant figures' and its importance in measurements.",
            "How do you convert units from one system to another (e.g., CGS to SI)?",
            "What is the least count of a measuring instrument, and how does it affect accuracy?",
            "What are systematic errors and random errors in measurements? Provide examples.",
            "Describe the method of finding the uncertainty in a measured value.",
            "What is a vernier caliper, and how is it used to measure small lengths?",
            "Explain the principle and working of a screw gauge.",
            "What is parallax error, and how can it be avoided?",
            "Discuss the difference between accuracy and precision in measurement.",
            "Explain the concept of dimensional consistency. Provide an example where it is applied.",
            "How are the units of speed, force, and energy derived from fundamental units?",
            "What is the role of standard units in physics?",
            "Describe how to measure the volume of an irregularly shaped object using the water displacement method."
          ],
        ...
        },
        {
          ...
          questions : [
              ...
              "A car C moving with a speed of 65 km h–1 on a straight road is ahead of motorcycle M moving with the speed of 80 km h–1 in the same direction. What is the velocity of M relative to C?",
              "How long does a car take to travel 30 m, if it accelerates from rest at a rate of 2.0 m s–2?",
              "A motorcyclist covers half of the distance between two places at a speed of 30 km h–1 and the second half at the speed of 60 km h–1. Compute the average speed of the motorcycle.",
              "A duck, flying directly south for the winter, flies with a constant velocity of 20 km h–1 to a distance of 25 km. How long does it take for the duck to fly this distance?",
              "Bangalore is 1200 km from New Delhi by air (straight line distance) and 1500 km by train. If it takes 2 h by air and 20 h by train, calculate the ratio of the average speeds.",
              "A car accelerates along a straight road from rest to 50 km h–1 in 5.0 s. What is the magnitude of its average acceleration?",
              "A body with an initial velocity of 2.0 m/s is accelerated at 8.0 m/s² for 3 seconds. (i) How far does the body travel during the period of acceleration? (ii) How far would the body travel if it were initially at rest?",
              "A body is thrown vertically upward, with a velocity of 10 m/s. What will be the value of the velocity and acceleration of the body at the highest point?",
              "A lady drove to the market at a speed of 8 km h–1. Finding market closed, she came back home at a speed of 10 km h–1. If the market is 2 km away from her home, calculate the average velocity and average speed.",
              "A body starting from rest covers a distance of 40 m in 4 s with constant acceleration along a straight line. Compute its final velocity and the time required to cover half of the total distance.",
           
            
            "Define displacement and how it differs from distance.",
            "What is the difference between average speed and average velocity?",
            "Explain uniform motion with an example.",
            "What is instantaneous velocity, and how is it measured?",
            "Derive the equation for uniformly accelerated motion: v = u + at.",
            "State and explain the three equations of motion.",
            "How do you graphically represent uniform and non-uniform motion?",
            "Explain the concept of acceleration and provide examples of positive and negative acceleration.",
            "What is the difference between scalar and vector quantities? Give examples.",
            "Explain relative velocity with a real-life example.",
            "What is the significance of the area under a velocity-time graph?",
            "Derive the equation for displacement: s = ut + (1/2)at^2.",
            "How do you determine the acceleration from a velocity-time graph?",
            "Explain free fall and how it relates to acceleration due to gravity.",
            "What are the conditions for zero acceleration in motion?",
            "How is motion along a straight line different from motion along a curved path?",
            "What are the units and dimensions of velocity and acceleration?",
            "Explain the concept of uniform acceleration with a practical example.",
            "How do you solve problems involving relative motion?",
            "Describe the process for calculating average speed over a round trip with different speeds in each direction."
          ],
        ...
        },
        {
          ...
          questions : [
              ...
              "Define unit vector and position vector.",
              "State and explain parallelogram law of vectors. Deduce expression for the magnitude and direction of the resultant vector.",
              "State triangle law of forces.",
              "Define scalar product and vector product of two vectors.",
              "A force 6i + 12j + 8k produces a displacement of 2i + 8j + 2k. Find the work done.",
              "Two vectors are given by 5i - 3j and 3i - 5j. Calculate their scalar and vector products.",
              "What is a projectile? Show that the path of a projectile is a parabola.",
              "Obtain expressions for the time of flight and the maximum height for a projectile.",
              "Derive an equation for the trajectory of a projectile.",
              "A string can sustain a maximum force of 100 N without breaking. A mass of 1 kg is tied to one end of the piece of string 1 m long and it is rotated in a horizontal plane. Compute the maximum speed with which the body can be rotated without breaking the string.",
              "A motorcyclist passes a curve of radius 50 m with a speed of 10 m/s. What will be the centripetal acceleration when turning the curve?",
              "A bullet is fired with an initial velocity of 300 m/s at an angle of 30° with the horizontal. At what distance from the gun will the bullet strike the ground?",
              "A shell is fired at an angle of elevation of 30° with a velocity of 500 m/s. Calculate the vertical and horizontal components of the velocity, the maximum height that the shell reaches, and its range.",
              "An airplane drops a food packet from a height of 2000 m above the ground while in horizontal flight at a constant speed of 200 km/h. How long does the packet take to fall to the ground? How far ahead (horizontally) of the point of release does the packet land?",
              "A car is rounding a curve of radius 200 m at a speed of 60 km/h. What is the centripetal force on a passenger of mass m = 90 kg?",
              "Define uniform circular motion. Give a few examples.",
              "Derive an expression for centripetal acceleration.",
           
            
            

            "What is motion in a plane? Provide examples.",
            "Explain the difference between scalar and vector quantities with examples.",
            "How do you represent a vector in a plane?",
            "Explain the methods of adding vectors graphically (tip-to-tail method).",
            ...
            "Explain how to find the magnitude and direction of a resultant vector.",
            "What is relative velocity in two dimensions, and how is it calculated?",
            "Explain projectile motion and its main characteristics.",
            "Derive the equations for the horizontal and vertical components of projectile motion.",
            "What is the range of a projectile, and how do you calculate it?",
            "What factors affect the maximum height and time of flight of a projectile?",
            "Explain uniform circular motion and its properties.",
            "What is centripetal acceleration, and how is it derived?",
            "Provide examples of real-life applications of projectile motion.",
            "How do you analyze the motion of an object moving in two perpendicular directions simultaneously?",
            "What is the trajectory of a projectile, and how can it be described mathematically?",
            "Explain the difference between horizontal and oblique projectile motion.",
            "What is the equation of motion for an object moving in a plane with uniform acceleration?"
          ],
        ...
        },
        {
          ...
          subchapters: [],
          questions : [
            "Which of the following will always be in the direction of net external force acting on the body? (a) displacement (b) velocity (c) acceleration (d) change in momentum",
            "When a constant net external force acts on an object which of the following may not change? (a) position (b) speed (c) velocity (d) acceleration",
            "A 0.5 kg ball is dropped from such a height that it takes 4 s to reach the ground. Calculate the change in momentum of the ball.",
            "In which case will there be larger change in momentum of a 2 kg object: (a) When 10 N force acts on it for 1 s? (b) When 10 N force acts on it for 1 m? Calculate the change in momentums in each case.",
            "A ball of mass 20 kg is lifted with the help of a rope at a constant acceleration of 6 m/s². Calculate air drag on the ball.",
            "A load of mass 20 kg is lifted with the help of a rope at a constant acceleration. The load covers a height of 5 m in 2 seconds. Calculate the tension in the rope. (g = 10 m/s²)",
            "In a rocket, mass ‘m’ changes with time. Write down the mathematical form of Newton’s law in this case and interpret it physically.",
            "A ball of mass 0.1 kg moving at 10 m/s is deflected by a wall at the same speed in the given direction. What is the magnitude of the change in momentum of the ball?",
            "Find the average recoil force on a machine gun that is firing 150 bullets per minute, each with a speed of 900 m/s. Mass of each bullet is 12 g.",
            "Explain why, when catching a fast-moving ball, the hands are drawn back while the ball is being brought to rest.",
            "A constant force of magnitude 20 N acts on a body of mass 2 kg, initially at rest, for 2 seconds. What will be the velocity of the body after (a) 1 second from start? (b) 3 seconds from start?",
            "How does a force acting on a block in the given direction keep the block from sliding down the vertical wall?",
            "A 1.2 kg block is resting on a horizontal surface. The coefficient of static friction between the block and the surface is 0.5. What will be the magnitude and direction of the force of friction on the block when the magnitude of the external force acting on the block in the horizontal direction is (a) 0 N? (b) 4.9 N? (c) 9.8 N?",
            "For a block on a surface, the maximum force of static friction is 10 N. What will be the force of friction on the block when a 5 N external force is applied to it parallel to the surface?",
            "What minimum horizontal force F is required to keep a 5 kg block at rest on an inclined plane of inclination 30°. The coefficient of static friction between the block and the inclined plane is 0.25. (g = 10 m/s²)",
            "Two blocks P and Q of masses m1 = 2 kg and m2 = 3 kg respectively are placed in contact with each other on a horizontal frictionless surface. An external force F = 10 N is applied to the block ‘P’ in the direction parallel to the surface. Find (a) the acceleration of the blocks (b) the force with which block P exerts on block Q.",
            "Two blocks P and Q of masses m1 = 2 kg and m2 = 4 kg are connected to a third block R of mass M as shown. For what maximum value of M will the system be in equilibrium? The frictional force acting on each block is half the force of normal reaction on it.",
            "A 2 kg block is pushed up on an inclined plane of inclination θ = 37° imparting it a speed of 20 m/s. How much distance will the block travel before coming to rest? The coefficient of kinetic friction between the block and the inclined plane is μk = 0.5. (g = 10 m/s², sin 37° = 0.6, cos 37° = 0.8)",
            "The linear momentum of a particle as a function of time ‘t’ is given by p = at + b, where a and b are positive constants. What is the force acting on the particle?",
            "On a smooth horizontal surface, a block A of mass 10 kg is kept. On this block, a second block B of mass 5 kg is kept. The coefficient of friction between the two blocks is 0.2. A horizontal force of 20 N is applied on the lower block. What is the force of friction between the blocks? (g = 10 m/s²)",
            "A person of mass 60 kg is in a lift, standing on a weighing machine. What are the readings of the weighing machine in the following situations: (a) Lift moving upwards with an acceleration of 1.2 m/s² (b) Lift moving downwards with an acceleration of 1.2 m/s² (c) Lift moving upwards with a uniform velocity of 5 m/s (d) Lift falling freely.",
            "Two blocks of mass 3 kg and 4 kg are suspended at the ends of a massless string passing over a frictionless pulley. Find the acceleration of the system and the tension in the string. (g = 10 m/s²)",
            "A fixed pulley with a smooth groove has a light string passing over it with a 5 kg attached on one side and a 4 kg on the other side. Another 4 kg is hung from the other 4 kg with another light string. If the system is released from rest, find the common acceleration. (g = 10 m/s²)",
            "Two people are pulling a rope in opposite directions, each with a force F. Find the tension in the rope.",
        ...
        },
        {
          ...
          subchapters: [],
          questions : [
            "If two particles have the same kinetic energy, are their momenta also the same? Explain.",
            "A particle in motion collides with another one at rest. Is it possible that both of them are at rest after the collision?",
            "Does the total mechanical energy of a system remain constant when dissipative forces work on the system?",
            "A child throws a ball vertically upwards with a velocity of 20 m/s. (a) At what point is the kinetic energy maximum? (b) At what point is the potential energy maximum?",
            "A block of mass 3 kg moving with a velocity of 20 m/s collides with a spring of force constant 1200 N/m. Calculate the maximum compression of the spring.",
            "What will be the compression of the spring in question 5 at the moment when the kinetic energy of the block is equal to twice the elastic potential energy of the spring?",
            "The power of an electric bulb is 60 W. Calculate the electrical energy consumed in 30 days if the bulb is lighted for 12 hours per day.",
            "1000 kg of water falls every second from a height of 120 m. The energy of this falling water is used to generate electricity. Calculate the power of the generator assuming no losses.",
            "The speed of a 1200 kg car is 90 km/h on a highway. The driver applies brakes to stop the car. The car comes to rest in 3 seconds. Calculate the average power of the brakes.",
            "A 400 g ball moving with a speed of 5 m/s has an elastic head-on collision with another ball of mass 600 g initially at rest. Calculate the speed of the balls after the collision.",
            "A bullet of mass 10 g is fired with an initial velocity of 500 m/s. It hits a 20 kg wooden block at rest and gets embedded into the block. (a) Calculate the velocity of the block after the impact. (b) How much energy is lost in the collision?",
            "An object of mass 6 kg is resting on a horizontal surface. A horizontal force of 15 N is constantly applied on the object. The object moves a distance of 100 m in 10 seconds. (a) How much work does the applied force do? (b) What is the kinetic energy of the object after 10 seconds? (c) What is the magnitude and direction of the frictional force (if there is any)? (d) How much energy is lost during motion?",
            "A, B, C, and D are four points on a hemispherical cup placed inverted on the ground. Diameter BC = 50 cm. A 250 g particle at rest at A slides down along the smooth surface of the cup. Calculate: (a) Potential energy at A relative to B. (b) Speed at point B (lowest point). (c) Kinetic and potential energy at D. Do you find that the mechanical energy of the block is conserved? Why?",
            ...
            "The mass of a car is 1000 kg. It starts from rest and attains a speed of 15 m/s in 3.0 seconds. Calculate: (a) The average power of the engine. (b) The work done on the car by the engine.",
            "A ball of mass 0.6 kg moving with a speed of 2 m/s collides with a ball of mass 0.8 kg. If the collision is elastic, find the velocities of the two balls after the collision.",
            "A ball of mass 0.2 kg is allowed to fall on a plane surface from a height of 1 m. After the collision, the ball rebounds to a height of 0.64 m. What is the value of the coefficient of restitution between the ball and the surface?",
            "A bomb at rest explodes into two fragments of masses 1 kg and 2 kg respectively. If the speed of the smaller fragment is 200 m/s, what is the speed of the other fragment?",
            "A machine gun can fire 240 bullets per minute. The speed of each bullet is 500 m/s and the power of the gun is 2.5 kW. Find the mass of each bullet.",
            "A passenger of mass 70 kg with a bag of mass 30 kg on his head is climbing a staircase in a railway station to reach his platform. The height of each step is 30 cm and there are 30 steps in the staircase. Calculate the total work done aganist the gravitational attraction."
          ],
        ...
        },
        {
          ...
          subchapters: [],
          questions : [
            "The weight Mg of a body is shown, generally, as acting at the centre of mass of the body. Does this mean that the earth does not attract other particles?",
            "Is it possible for the centre of mass of a body to lie outside the body? Give two examples to justify your answer.",
            "In a molecule of carbon monoxide (CO), the nuclei of the two atoms are 1.13 × 10^–10 m apart. Locate the centre of mass of the molecule.",
            "A grinding wheel of mass 5.0 kg and diameter 0.20 m is rotating with an angular speed of 100 rad/s. Calculate its kinetic energy. Through what distance would it have to be dropped in free fall to acquire this kinetic energy? (Take g = 10.0 m/s^2).",
            "A wheel of diameter 1.0 m is rotating about a fixed axis with an initial angular speed of 2 rev/s. The angular acceleration is 3 rev/s^2. (a) Compute the angular velocity after 2 seconds. (b) Through what angle would the wheel have turned during this time? (c) What is the tangential velocity of a point on the rim of the wheel at t = 2 s? (d) What is the centripetal acceleration of a point on the rim of the wheel at t = 2 s?",
            "A wheel rotating at an angular speed of 20 rad/s is brought to rest by a constant torque in 4.0 seconds. If the moment of inertia of the wheel about the axis of rotation is 0.20 kg m^2, calculate the work done by the torque in the first two seconds.",
            "Two wheels are mounted on the same axle. The moment of inertia of wheel A is 5 × 10^–2 kg m^2, and that of wheel B is 0.2 kg m^2. Wheel A is set spinning at 600 rev/min while wheel B is stationary. A clutch now acts to join A and B so that they must spin together. (a) At what speed will they rotate? (b) How does the rotational kinetic energy before joining compare with the kinetic energy after joining? (c) What torque does the clutch deliver if A makes 10 revolutions during the operation of the clutch?",
            "You are given two identically looking spheres and told that one of them is hollow. Suggest a method to detect the hollow one.",
            "The moment of inertia of a wheel is 1000 kg m^2. Its rotation is uniformly accelerated. At some instant of time, its angular speed is 10 rad/s. After the wheel has rotated through an angle of 100 radians, the angular velocity of the wheel becomes 100 rad/s. Calculate the torque applied to the wheel and the change in its kinetic energy.",
            "A disc of radius 10 cm and mass 1 kg is rotating about its own axis. It is accelerated uniformly from rest. During the first second, it rotates through 2.5 radians. Find the angle rotated during the next second. What is the magnitude of the torque acting on the disc?",
            "Moment of Inertia of a spherical shell about its diameter is (2/3)MR^2. Determine the moment of inertia of the spherical shell about its tangent (hint: use the parallel axes theorem).",
            "When the radius of gyration is increased by 10%, what percentage of increase is observed in the moment of inertia?",
            "A flywheel of moment of inertia 0.3 kg m^2 is making 300 revolutions per minute. What torque must be applied on it so that it gets stopped in 20 seconds?",
            "The moment of inertia of a wheel is 0.63 kg m^2. Calculate the amount of work done in increasing its angular velocity from 40 rpm to 80 rpm.",
            "Find the torque of a force (7i + 3j – 3k) about the origin. The force acts on a particle whose position vector is (i + j – k)."
          ],
        ...
        },
        {
          ...
          subchapters: [],
          questions :[
            "Distinguish between a periodic and an oscillatory motion.",
            "What is simple harmonic motion?",
            "Which of the following functions represent (i) a simple harmonic motion (ii) a periodic but not simple harmonic (iii) a non-periodic motion? Give the period of each periodic motion:\n(i) sin(ωt) + cos(ωt)\n(ii) 1 + ω^2 + ωt\n(iii) 3cos(ωt) - π/4",
            "The time period of oscillations of a mass 0.1 kg suspended from a Hooke’s spring is 1 second. Calculate the time period of oscillation of mass 0.9 kg when suspended from the same spring.",
            "What is phase angle? How is it related to angular frequency?",
            "Why is the time period of a simple pendulum independent of the mass of the bob, when the period of a simple harmonic oscillator is T = 2π√(m/k)?",
            ...
            "Show that the projection of a uniform circular motion on the diameter of the circle is a simple harmonic motion. Obtain an expression for the time period of a simple harmonic oscillator in terms of mass and force constant.",
            "Obtain expressions for the instantaneous kinetic energy, potential energy, and the total energy of a simple harmonic oscillator.",
            "Show graphically how the potential energy U, the kinetic energy K, and the total energy E of a simple harmonic oscillator vary with the displacement from the equilibrium position.",
            "The displacement of a moving particle from a fixed point at any instant is given by x = a cos(ωt) + b sin(ωt). Is the motion of the particle simple harmonic? If your answer is no, explain why? If your answer is yes, calculate the amplitude of vibration and the phase angle.",
            "A simple pendulum oscillates with an amplitude of 0.04 m. If its time period is 10 s, calculate the maximum velocity.",
            "Imagine a ball dropped in a frictionless tunnel cut across the earth through its center. Obtain an expression for its time period in terms of the radius of the earth and the acceleration due to gravity.",
            "A block of mass m = 2 kg is connected to two springs, each of force constant k = 400 N/m. The block is displaced by 0.05 m from the equilibrium position and then released. Calculate:\n(a) The angular frequency ω of the block,\n(b) Its maximum speed,\n(c) Its maximum acceleration,\n(d) Total energy dissipated against damping when it comes to rest."
          ],
        ...
        },
        {
          ...
          subchapters: [],
          questions : [
            "1. You have learnt that the gravitational attraction is mutual. If that is so, does an apple also attract the earth? If yes, then why does the earth not move in response?",
            "2. We set up an experiment on earth to measure the force of gravitation between two particles placed at a certain distance apart. Suppose the force is of magnitude F. We take the same set up to the moon and perform the experiment again. What would be the magnitude of the force between the two particles there?",
            "3. Suppose the earth expands to twice its size without any change in its mass. What would be your weight if your present weight were 500 N?",
            "4. Suppose the earth loses its gravity suddenly. What would happen to life on this planet?",
            "5. Refer to Fig. 8.8 which shows the structure of the earth. Calculate the values of g at the bottom of the crust (depth 25 km) and at the bottom of the mantle (depth 2855 km).",
            "6. Derive an expression for the mass of the earth, given the orbital period of the moon and the radius of its orbit.",
            "7. Suppose your weight is 500 N on the earth. Calculate your weight on the moon. What would be your mass on the moon?",
            "8. A polar satellite is placed at a height of 800 km from earth's surface. Calculate its orbital period and orbital velocity.",
            "9. State the Law of gravitation and explain how the value of Gravitation constant G can be determined by Cavendish experiment?",
            "10. Define the gravitational field and obtain the expression for the gravitational field strength.",
            "11. Define the gravitational potential energy and obtain the expression for it.",
            "12. State the Kepler's laws of planetary motion."
          ],          
        },
        {
          ...
          subchapters: [],
          questions : [
            "Define the term elasticity. Give examples of elastic and plastic objects.",
            ...
            "Define Young’s modulus, Bulk modulus and Rigidity modulus.",
            "Discuss the behaviour of a metallic wire under increasing load with the help of a stress–strain graph.",
            "Why steel is more elastic than rubber.",
            "Why Poisson’s ratio has no units.",
            "In the three states of matter i.e., solid, liquid and gas, which is more elastic and why?",
            "A metallic wire 4m in length and 1mm in diameter is stretched by putting a mass 4 kg. Determine the elongation produced. Given that the Young’s modulus of elasticity for the material of the wire is 13.78 × 10^10 Nm–2.",
            "A sphere contracts in volume by 0.02% when taken to the bottom of sea 1 km deep. Calculate the bulk modulus of the material of the sphere. You may take density of sea water as 1000 kg m–3 and g = 9.8 ms–2.",
            "How much force is required to have an increase of 0.2% in the length of a metallic wire of radius 0.2 mm. Given Y = 9 × 10^10 Nm–2.",
            "What are shearing stress, shearing strain and modulus of rigidity?",
            "The upper face of the cube of side 10 cm is displaced 2 mm parallel to itself when a tangential force of 5 × 10^5 N is applied on it, keeping lower face fixed. Find out the strain.",
            "Property of elasticity is of vital importance in our lives. How does the plasticity help us?",
            "A wire of length L and radius r is clamped rigidly at one end. When the other end of wire is pulled by a force F, its length increases by x. Another wire of the same material of length 2L and radius 2r, when pulled by a force 2F, what will be the increase in its length.",
            "Define the Elastic potential energy. Obtain the expression for elastic potential energy."
          ],
        ...
        },
        {
          ...
          questions : [
            ...
            "5. The hydrostatic pressure due to a liquid filled in a vessel at a depth 0.9 m is 3.0 Nm–2. What will be the hydrostatic pressure at a hole in the side wall of the same vessel at a depth of 0.8 m.",
            "6. In a hydraulic lift, how much weight is needed to lift a heavy stone of mass 1000 kg? Given the ratio of the areas of cross section of the two pistons is 5. Is the work output greater than the work input? Explain.",
            "7. A liquid filled in a capillary tube has convex meniscus. If Fa is force of adhesion, Fc is force of cohesion and θ is the angle of contact, which of the following relations should hold good? (a) Fa > Fc sin θ; (b) Fa < Fc sin θ; (c) Fa cos θ = Fc; (d) Fa sin θ > Fc.",
            ...
            "10. Calculate the approximate rise of a liquid of density 103 kg m–3 in a capillary tube of length 0.05 m and radius 0.2 × 10–3 m. Given surface tension of the liquid for the material of that capillary is 7.27 × 10–2 Nm–1.",
            ...
            "18. State Bernoulli’s principle. Explain its application in the design of the body of an aeroplane.",
            "19. Explain Why: (i) A spinning tennis ball curves during the flight? (ii) A ping pong ball keeps on dancing on a jet of water without falling on to either side? (iii) The velocity of flow increases when the aperture of water pipe is decreased by squeezing its opening. (iv) A small spherical ball falling in a viscous fluid attains a constant velocity after some time. (v) If mercury is poured on a flat glass plate, it breaks up into small spherical droplets.",
            "20. Calculate the terminal velocity of an air bubble with diameter which rises in a liquid of viscosity 0.15 kg m–1 s–1 and density 0.9 gm cm–3. What will be the terminal velocity of the same bubble while rising in water? For water η = 10–2 kg m–1 s–1.",
            "21. A pipe line 0.2 m in diameter, flowing full of water has a constriction of diameter 0.1 m. If the velocity in the 0.2 m pipe-line is 2 m s–1, calculate (i) the velocity in the constriction, and (ii) the discharge rate in cubic meters per second.",
            "22. (i) At what velocity does a steel ball with a radius of 1 mm fall in a tank of glycerine when its acceleration is half that of a freely falling body (ii) What is the terminal velocity of the ball? The density of steel and of glycerine are 8.5 gm cm–3 and 1.32 gm cm–3 respectively, viscosity of glycerine is 8.3 poise.",
            "23. Water at 20°C flows with a speed of 50 cm s–1 through a pipe of diameter of 3 mm. (i) What is Reynold’s number? (ii) What is the nature of flow? Given, viscosity of water at 20°C as 1.005 × 10–2 poise and Density of water at 20°C as 1 gm cm–3.",
            "24. Modern aeroplane design calls for a lift of about 1000 Nm–2 of wing area. Assume that air flows past the wing of an aircraft with streamline flow. If the velocity of flow past the lower wing surface is 100 ms–1, what is the required velocity over the upper surface to give a desired lift of 1000 Nm–2? The density of air is 1.3 kg m–3.",
            "25. Water flows horizontally through a pipe of varying cross-section. If the pressure of water equals 5 cm of mercury at a point where the velocity of flow is 28 cm s–1, then what is the pressure at another point, where the velocity of flow is 70 cm s–1? [Tube density of water 1 gm cm–3]."
          ],
        ...
        },
        {
          ...
          subchapters: [],
          questions : [
            "1. A thermos flask is made of a double-walled glass bottle enclosed in a metal container. The bottle contains some liquid whose temperature we want to maintain. Explain how the construction of the flask helps in minimizing heat transfer due to conduction, convection, and radiation.",
            "2. The wavelength corresponding to the emission of maximum energy of a star is 4000Aº. Compute the temperature of the star. (1 Aº = 10–8 cm).",
            "3. A blackened solid copper sphere of radius 2cm is placed in an evacuated enclosure whose walls are kept at 1000°C. At what rate must energy be supplied to the sphere to keep its temperature constant at 127°C?",
            "4. Comment on the statement 'A good absorber must be a good emitter'.",
            "5. A copper pot whose bottom surface is 0.5 cm thick and 50 cm in diameter rests on a burner which maintains the bottom surface of the pot at 110°C. A steady heat flows through the bottom into the pot where water boils at atmospheric pressure. The actual temperature of the inside surface of the bottom of the pot is 105°C. How many kilograms of water boil off in one hour?",
            "6. Define the coefficient of thermal conductivity. List the factors on which it depends.",
            "7. Distinguish between conduction and convection methods of heat transfer.",
            "8. If two or more rods of equal area of cross-section are connected in series, show that their equivalent thermal resistance is equal to the sum of the thermal resistance of each rod. [Hint: Thermal resistance is reciprocal of thermal conductivity]",
            "9. The ratio of the coefficient of thermal conductivities of different materials is 4:3. To have the same thermal resistance of two rods of these materials of equal thickness, what should be the ratio of their lengths?",
            "10. Why do we feel warmer on a winter night when clouds cover the sky than when the sky is clear?",
            "11. Why does a piece of copper or iron appear hotter to touch than a similar piece of wood even when both are at the same temperature?",
            "12. Why is it more difficult to sip hot tea from a metal cup than from a china-clay cup?",
            "13. Why are woolen clothes warmer than cotton clothes?",
            "14. Why do two layers of cloth of equal thickness provide a warmer covering than a single layer of cloth of double the thickness?",
            "15. Can water be boiled by convection inside an earth satellite?",
            "16. A 500 W bulb is glowing. We keep one hand 5 cm above it and the other 5 cm below it. Why is more heat experienced at the upper hand?",
            "17. Two vessels of different materials are identical in size and dimensions. They are filled with equal quantities of ice at 0°C. If the ice in both vessels melts completely in 25 minutes and 20 minutes respectively, compare the thermal conductivities of the metals of both vessels.",
            "18. Calculate the thermal resistivity of a copper rod 20 cm in length and 4 cm in diameter. Given thermal conductivity of copper = 9.2 × 10–2, and temperature difference across the ends of the rod is 50°C. Calculate the rate of heat flow."
          ],
        ...
        },
        {
         ...
         questions : [
            ...
            "2. What do you mean by an indicator diagram? Derive an expression for the work done during expansion of an ideal gas.",
            "3. Define temperature using the Zeroth law of thermodynamics.",
            "4. State the first law of thermodynamics and its limitations.",
            "5. What is the difference between isothermal, adiabatic, isobaric, and isochoric processes?",
            ...
            "9. Calculate the change in the internal energy of a system when (a) the system absorbs 2000 J of heat and produces 500 J of work, (b) the system absorbs 1100 J of heat and 400 J of work is done on it.",
            "10. A Carnot’s engine whose temperature of the source is 400K takes 200 calories of heat at this temperature and rejects 150 calories of heat to the sink. (i) What is the temperature of the sink? (ii) Calculate the efficiency of the engine."
          ],
        ...
        },
        {
          ...
          questions : [
            ...
            "2. What will be the velocity and kinetic energy of the molecules of a substance at absolute zero temperature?",
            "3. If the absolute temperature of a gas is raised four times, what will happen to its kinetic energy, root-mean square velocity, and pressure?",
            "4. What should be the ratio of the average velocities of hydrogen molecules (molecular mass = 2) and that of oxygen molecules (molecular mass = 32) in a mixture of two gases to have the same kinetic energy per molecule?",
            "5. If three molecules have velocities 0.5, 1, and 2 km/s respectively, calculate the ratio between their root mean square and average speeds.",
            "6. Explain what is meant by the root-mean square velocity of the molecules of a gas. Use the concepts of kinetic theory of gases to derive an expression for the root mean square velocity of the molecules in terms of pressure and density of the gas.",
            "7. (i) Calculate the average translational kinetic energy of a neon atom at 25°C. (ii) At what temperature does the average energy have half this value?",
            "8. A container of volume 50 cm³ contains hydrogen at a pressure of 1.0 Pa and at a temperature of 27°C. Calculate (a) the number of molecules of the gas in the container, and (b) their root-mean square speed. (R = 8.3 J mol⁻¹ K⁻¹, N = 6 × 10²³ mol⁻¹. Mass of 1 mole of hydrogen molecule = 20 × 10⁻³ kg mol⁻¹).",
            "9. A closed container contains hydrogen which exerts pressure of 20.0 mm Hg at a temperature of 50 K. (a) At what temperature will it exert pressure of 180 mm Hg? (b) If the root-mean square velocity of the hydrogen molecules at 10.0 K is 800 m/s, what will be their root-mean square velocity at this new temperature?",
            "10. State the assumptions of kinetic theory of gases.",
            "11. Find an expression for the pressure of a gas.",
            "12. Deduce Boyle’s law and Charles’s law from the kinetic theory of gases.",
            "13. What is the interpretation of temperature on the basis of kinetic theory of gases?",
            "14. What is Avogadro’s law? How can it be deduced from the kinetic theory of gases?",
            "15. Calculate the root-mean square velocity of the molecules of hydrogen at 0°C and at 100°C (Density of hydrogen at 0°C and 760 mm of mercury pressure = 0.09 kg m⁻³).",
            "16. Calculate the pressure in mm of mercury exerted by hydrogen gas if the number of molecules per m³ is 6.8 × 10²⁴ and the root-mean square speed of the molecules is 1.90 × 10³ m/s. Avogadro’s number 6.02 × 10²³ and molecular weight of hydrogen = 2.02).",
            "17. Define specific heat of a gas at constant pressure. Derive the relationship between cₚ and cᵥ.",
            "18. Define specific heat of gases at constant volume. Prove that for a triatomic gas cᵥ = 3R.",
            "19. Calculate cₚ and cᵥ for argon. Given R = 8.3 J mol⁻¹ K⁻¹."
          ],
        ...
        },
        {
         ...
         questions : [
            ...
            "2. What are different types of waves?",
            "3. Define Longitudinal and transverse waves and write the differences between them.",
            "4. What are progressive waves? What is the speed of progressive waves?",
            "5. A guitar string has a length of 0.75 meters. The tension in the string is 80 newtons, and the linear mass density is 0.02 kg/m. Calculate the speed of the wave travelling along the string.",
            "6. A sound wave with a frequency of 440 Hz is produced in air. If the speed of sound in air is 343 meters per second (m/s), what is the wavelength of the sound wave?",
            "7. Explain the principle of superposition of waves.",
            "8. Explain the reflection of waves in different cases.",
            "9. Explain the formation of different harmonics in (a) Closed end (b) Open end organ pipes.",
            "10. An open-end organ pipe has a length of 2.4 meters. Calculate the fundamental frequency (first harmonic) of this pipe. Take the speed of sound in air to be approximately 343 meters per second (m/s).",
            "11. An open-end organ pipe produces a third harmonic with a frequency of 225 Hz. Determine the length of the pipe. Take the speed of sound in air to be approximately 343 meters per second (m/s).",
            "12. The fundamental frequency of a closed organ pipe of length 20 cm is equal to the second overtone (third harmonic) of an organ pipe open at both ends. What is the length of the organ pipe open at both the ends?",
            "13. How are echoes produced?",
            "14. What are Beats?",
            "15. Calculate the number of beats produced when two waves of frequency 10 Hz and 15 Hz overlap.",
            "16. Two sound waves with frequencies of 320 Hz and 328 Hz are produced simultaneously. Calculate the beat frequency.",
            "17. What is the Doppler effect? Explain the Doppler effect in different cases?"
          ],
